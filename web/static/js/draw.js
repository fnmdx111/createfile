...
(function() {
  var container, fc_container, fill_ct_text, fire_post, maybe, _canonical_time_format, _data, _hide_loading, _show_loading,
    __slice = [].slice;
  ...
  fire_post = function() {
    ...
    return $.post('/cl', {
      ...
      datetime_start: moment(maybe($('#dt-start').val(), '0001-01-01 00:00:00.000'), _canonical_time_format).valueOf(),
      datetime_end: moment(maybe($('#dt-end').val(), '9999-12-31 23:59:59.999'), _canonical_time_format).valueOf(),
